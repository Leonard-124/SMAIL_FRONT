...
//             <Link
//               to="/order"
//               className="flex items-center gap-1 bg-green-700 text-white px-4 py-2 rounded-lg hover:bg-green-800 transition-colors font-medium"
//             >
...
//             <Link
//               to="/order"
//               className="flex items-center gap-2 bg-green-700 text-white px-4 py-2 rounded-lg font-medium w-fit"
//               onClick={() => setIsMenuOpen(false)}
//             >
//               <ShoppingBasket className="h-5 w-5" />
//               Order Now
